...
abstract class BaseTournamentSportGameGroupForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'tournament_team_group_token_id'   => new sfWidgetFormInputText(),
      ...
      'number_of_teams_per_group'        => new sfWidgetFormInputText(),
      'number_of_participants_per_group' => new sfWidgetFormInputText(),
      ...
      'group_team_number_mandatory_flag' => new sfWidgetFormInputCheckbox(),
    ...
    $this->setValidators(array(
      ...
      'tournament_team_group_id'         => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('TournamentTeamGroup'), 'required' => false)),
      'tournament_team_group_token_id'   => new sfValidatorString(array('max_length' => 100, 'required' => false)),
      ...
      'number_of_teams_per_group'        => new sfValidatorInteger(array('required' => false)),
      'number_of_participants_per_group' => new sfValidatorInteger(array('required' => false)),
      ...
      'group_team_number_mandatory_flag' => new sfValidatorBoolean(array('required' => false)),
