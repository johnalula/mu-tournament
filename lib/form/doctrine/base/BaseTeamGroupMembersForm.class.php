...
/**
 * TeamGroupMembers form base class.
 *
 * @method TeamGroupMembers getObject() Returns the current form's model object
 *
 * @package    mu-TMS
 * @subpackage form
 ...
 */
abstract class BaseTeamGroupMembersForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'team_group_id'  => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('TeamGroup'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'team_group_id'  => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('TeamGroup'), 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('team_group_members[%s]');
