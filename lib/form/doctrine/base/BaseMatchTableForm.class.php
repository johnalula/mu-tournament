...
/**
 * MatchTable form base class.
 *
 * @method MatchTable getObject() Returns the current form's model object
 *
 * @package    mu-TMS
 * @subpackage form
 ...
 */
abstract class BaseMatchTableForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'palayed'         => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'palayed'         => new sfValidatorInteger(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('match_table[%s]');
