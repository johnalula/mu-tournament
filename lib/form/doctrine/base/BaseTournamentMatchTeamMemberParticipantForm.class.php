...
abstract class BaseTournamentMatchTeamMemberParticipantForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'team_group_member_participant_id'           => new sfWidgetFormInputText(),
      'team_group_member_participant_token_id'     => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'team_group_member_participant_id'           => new sfValidatorInteger(array('required' => false)),
      'team_group_member_participant_token_id'     => new sfValidatorString(array('max_length' => 100, 'required' => false)),
