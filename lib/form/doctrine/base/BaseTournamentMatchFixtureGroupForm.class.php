...
abstract class BaseTournamentMatchFixtureGroupForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'match_group_number'                            => new sfWidgetFormInputText(),
      'match_group_name'                              => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'match_group_number'                            => new sfValidatorInteger(array('required' => false)),
      'match_group_name'                              => new sfValidatorString(array('max_length' => 100, 'required' => false)),
