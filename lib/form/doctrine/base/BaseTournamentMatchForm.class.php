...
abstract class BaseTournamentMatchForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'parent_tournament_match_token_id' => new sfWidgetFormInputText(),
      ...
      'tournament_match_full_number'     => new sfWidgetFormInputText(),
      'tournament_match_round_mode'      => new sfWidgetFormInputText(),
      'tournament_match_result_mode'     => new sfWidgetFormInputText(),
      'round_type_mode'                  => new sfWidgetFormInputText(),
      'contestant_team_mode'             => new sfWidgetFormInputText(),
      'competition_mode'                 => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'parent_tournament_match_id'       => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('TournamentMatch'), 'required' => false)),
      'parent_tournament_match_token_id' => new sfValidatorString(array('max_length' => 100, 'required' => false)),
      ...
      'tournament_match_full_number'     => new sfValidatorString(array('max_length' => 100, 'required' => false)),
      'tournament_match_round_mode'      => new sfValidatorInteger(array('required' => false)),
      'tournament_match_result_mode'     => new sfValidatorInteger(array('required' => false)),
      'round_type_mode'                  => new sfValidatorInteger(array('required' => false)),
      'contestant_team_mode'             => new sfValidatorInteger(array('required' => false)),
      'competition_mode'                 => new sfValidatorInteger(array('required' => false)),
