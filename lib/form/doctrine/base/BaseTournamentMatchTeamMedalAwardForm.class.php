...
/**
 * TournamentMatchTeamMedalAward form base class.
 *
 * @method TournamentMatchTeamMedalAward getObject() Returns the current form's model object
 *
 * @package    symfony
 * @subpackage form
 ...
 */
abstract class BaseTournamentMatchTeamMedalAwardForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('tournament_match_team_medal_award[%s]');
