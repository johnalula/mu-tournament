...
/**
 * TeamGroup form base class.
 *
 * @method TeamGroup getObject() Returns the current form's model object
 *
 * @package    mu-TMS
 * @subpackage form
 ...
 */
abstract class BaseTeamGroupForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('team_group[%s]');
