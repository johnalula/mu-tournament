...
abstract class BaseTournamentMatchParticipantTeamForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'opponent_group_participant_team_id'       => new sfWidgetFormInputText(),
      'opponent_group_participant_team_token_id' => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'opponent_group_participant_team_id'       => new sfValidatorInteger(array('required' => false)),
      'opponent_group_participant_team_token_id' => new sfValidatorString(array('max_length' => 100, 'required' => false)),
