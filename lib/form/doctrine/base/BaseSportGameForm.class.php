...
abstract class BaseSportGameForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'sport_game_type_mode'                   => new sfWidgetFormInputText(),
      'contestant_mode'                        => new sfWidgetFormInputText(),
      'team_contestants_per_game_mode'         => new sfWidgetFormInputText(),
      'contestant_team_mode'                   => new sfWidgetFormInputText(),
      'jump_type_mode'                         => new sfWidgetFormInputText(),
      'throw_type_mode'                        => new sfWidgetFormInputText(),
      'win_result_table_point'                 => new sfWidgetFormInputText(),
      'draw_result_table_point'                => new sfWidgetFormInputText(),
      'loose_result_table_point'               => new sfWidgetFormInputText(),
      'result_ranking_mode'                    => new sfWidgetFormInputText(),
      'number_of_contestants_per_track_mode'   => new sfWidgetFormInputText(),
      'start_date'                             => new sfWidgetFormInputText(),
      'effective_date'                         => new sfWidgetFormInputText(),
      'end_date'                               => new sfWidgetFormInputText(),
      'enable_fixed_contestant_per_track_flag' => new sfWidgetFormInputCheckbox(),
      'enable_player_mode_flag'                => new sfWidgetFormInputCheckbox(),
    ...
    $this->setValidators(array(
      ...
      'sport_game_number'                      => new sfValidatorString(array('max_length' => 50, 'required' => false)),
      'sport_game_type_mode'                   => new sfValidatorInteger(array('required' => false)),
      'contestant_mode'                        => new sfValidatorInteger(array('required' => false)),
      'team_contestants_per_game_mode'         => new sfValidatorInteger(array('required' => false)),
      ...
      'throw_type_mode'                        => new sfValidatorInteger(array('required' => false)),
      'win_result_table_point'                 => new sfValidatorInteger(array('required' => false)),
      'draw_result_table_point'                => new sfValidatorInteger(array('required' => false)),
      'loose_result_table_point'               => new sfValidatorInteger(array('required' => false)),
      'result_ranking_mode'                    => new sfValidatorInteger(array('required' => false)),
      'number_of_contestants_per_track_mode'   => new sfValidatorInteger(array('required' => false)),
      ...
      'enable_fixed_contestant_per_track_flag' => new sfValidatorBoolean(array('required' => false)),
      'enable_player_mode_flag'                => new sfValidatorBoolean(array('required' => false)),
