...
abstract class BaseTeamForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'team_logo'           => new sfWidgetFormInputText(),
      'flag_logo_alias'     => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'team_logo'           => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'flag_logo_alias'     => new sfValidatorString(array('max_length' => 50, 'required' => false)),
