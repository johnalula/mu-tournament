...
/**
 * TournamentGroupParticipantTeamMember
 * 
 ...
 */
class TournamentGroupParticipantTeamMember extends PluginTournamentGroupParticipantTeamMember
{
	...
	public function makeConfirmation ()
	{
		...
		$this->confirm_status = trim(TournamentCore::$_ACTIVE); 
		$this->save();
		return $_flag;
	}
