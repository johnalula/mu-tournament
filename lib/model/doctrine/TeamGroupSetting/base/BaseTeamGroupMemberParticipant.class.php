...
/**
 * BaseTeamGroupMemberParticipant
 * 
 ...
 * @property integer $group_member_team_id
 * @property string $group_member_team_token_id
 ...
 * @property Doctrine_Collection $teamGroupMemberParticipantMatchParticipants
 * 
 * @package    symfony
 * @subpackage model
 * @author     John Haftom
 ...
 */
abstract class BaseTeamGroupMemberParticipant extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('mutms_tbl_team_group_member_participant');
        ...
        $this->hasColumn('group_member_team_id', 'integer', null, array(
             'type' => 'integer',
             ));
        $this->hasColumn('group_member_team_token_id', 'string', 100, array(
             'type' => 'string',
             'length' => 100,
             ));
    ...
    public function setUp()
    {
        ...
        $this->hasOne('SportGameTeamGroup', array(
             'local' => 'group_member_team_id',
             'foreign' => 'id',
             'onDelete' => 'CASCADE'));

        $this->hasMany('TournamentMatchParticipant as teamGroupMemberParticipantMatchParticipants', array(
             'local' => 'id',
             'foreign' => 'team_group_member_participant_id'));
