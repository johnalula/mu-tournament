...
class TournamentGroupParticipantTeamTable extends PluginTournamentGroupParticipantTeamTable
{
   ...
   public static function processNew ( $_orgID, $_orgTokenID, $_tournamentID, $_tournamentGroupID, $_tournamentGroupTokenID, $_sportGameGroupID, $_sportGameGroupTokenID, $_participantTeamID, $_participantTeamTokenID, $_teamGameParticipationID, $_teamGameParticipationTokenID, $_sportGameID, $_participantTeamName, $_sportGameGroupName, $_genderCategory, $_entryDate, $_teamStatus, $_description, $_dataCreationMode, $_userID, $_userTokenID )
	{
			switch ( trim($_dataCreationMode) ) {
				case SystemCore::$_SINGLE_DATA: 
						...
						$_gameParticipation = TeamGameParticipationTable::makeCandidateObject ( $_teamGameParticipationID, $_teamGameParticipationTokenID ) ;
						
						$_flag2 = $_gameParticipation->makeApproval ();
						
						$_tournamentGroup =  TournamentSportGameGroupTable::makeObject ($_sportGameGroupID, $_sportGameGroupTokenID );  
					
						$_flag1 = ($_tournamentGroup->hasPendingTeamGameParticipation ()) ? $_tournamentGroup->makePending():$_tournamentGroup->makeActivation();
					//$_flag1 = ($_tournamentGroup->checkInitiated () && $_tournamentGroup->hasPendingTeamGameParticipation ()) ? $_tournamentGroup->makePending():$_tournamentGroup->makeActivation();
				...
				case SystemCore::$_MULTIPLE_DATA: 
					...
					foreach($_candidateParticipantTeams as $_participantTeam ) {
						...
						$_gameParticipation = TeamGameParticipationTable::makeCandidateObject ( $_participantTeam->id, $_participantTeam->token_id ) ;
					...
					$_flag1 = ($_tournamentGroup->hasPendingTeamGameParticipation ()) ? ($_tournamentGroup->checkInitiated () ? $_tournamentGroup->makePending():true):$_tournamentGroup->makeActivation();
  ...
  // process list selection function 
	...
	*********************************************************/
	...
	// process list selection function 
   public static function makeCandidateParticipantTeamSelection ($_sportGameGroupID=null, $_sportGameID=null, $_genderCategoryID=null, $_qualificationStatus=null, $_status=null, $_keyword=null, $_exclusion=null, $_offset=0, $_limit=10 ) 
   {
		$_qry = Doctrine_Query::create()
				->select(self::appendQueryFields())
				->from("TournamentGroupParticipantTeam gmGrpTmPrt") 
	...
	// process list selection function 
   public static function makeCandidateSelection ($_tournamentGroupID=null, $_tournamentGroupTokenID=null, $_sportGameID=null, $_genderCategoryID=null, $_keyword=null, $_offset=0, $_limit=10 ) 
   {
		$_qry = Doctrine_Query::create()
				->select(self::appendQueryFields())
				->from("TournamentGroupParticipantTeam gmGrpTmPrt") 
