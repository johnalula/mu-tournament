...
/**
 * BaseGroupTeamMemberParticipant
 * 
 ...
 */
abstract class BaseGroupTeamMemberParticipant extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('mutms_tbl_group_team_member');
        $this->hasColumn('token_id', 'string', 100, array(
             'type' => 'string',
             'length' => 100,
             ));
        $this->hasColumn('team_group_id', 'integer', null, array(
             'type' => 'integer',
             ));
