...
class TournamentMatchTeamMemberParticipantTable extends PluginTournamentMatchTeamMemberParticipantTable
{
	...
	public static function processNew ( $_orgID, $_orgTokenID, $_tournamentMatchID, $_tournamentMatchTokenID, $_matchFixtureID, $_matchFixtureTokenID, $_matchFixtureGroupID, $_matchFixtureGroupTokenID, $_sportGameGroupID, $_sportGameGroupTokenID, $_participantTeamGroupID, $_participantTeamGroupTokenID, $_opponentParticipantTeamGroupID, $_opponentParticipantTeamGroupTokenID, $_matchFixtureName, $_participantTeamName, $_opponentParticipantTeamName, $_tournamentMatchVenu, $_matchDate, $_matchTime, $_matchStatus, $_description, $_contestantTeamMode, $_dataCreationMode, $_userID, $_userTokenID )
	{
			...
			switch ( trim($_contestantTeamMode) ) {
				...
				case TournamentCore::$_BATCH_CREATION_MODE:  
					...
					$_matchFixtureParticipant = self::processCreateBatch ($_matchFixtureID, $_matchFixtureTokenID, $_matchFixtureGroupID, $_matchParticipantTeamID, $_participantMemberID, $_participantMemberRoleID, $_matchFixtureName, $_participantTeamName, $_participantName, $_matchStatus, $_description );
	...
	//
	public static function processSave ($_matchFixtureID, $_matchFixtureTokenID, $_matchFixtureGroupID, $_matchParticipantTeamID, $_participantMemberID, $_participantMemberRoleID, $_matchFixtureName, $_participantTeamName, $_participantName, $_matchStatus, $_description )
	{
		//try {
			...
			$_nw->tournament_match_participant_team_id = trim($_matchParticipantTeamID); 
			...
			$_nw->description = SystemCore::processDescription ( (trim($_participantName).' from '.trim($_participantTeamName).' participating in '.trim($_matchFixtureName)), trim($_description) );  
			$_nw->save(); 
  ...
  // process list selection function 
   public static function processSelection ( $_tournamentID=null, $_tournamentMatchID=null, $_tournamentMatchTokenID=null, $_matchFixtureID=null, $_sportGameGroupID=null, $_sportGameID=null, $_teamID=null, $_keyword=null, $_offset=0, $_limit=10 ) 
   {
		$_qry = Doctrine_Query::create()
				...
				->leftJoin("mtchPrtTmMbr.TournamentMatchParticipantTeam mtchPrtTm on mtchPrtTm.tournament_match_fixture_group_id = mtchFixGrp.id ") 
