...
/**
 * PairContestantTeamGroupTable
 * 
 * This class has been auto-generated by the Doctrine ORM Framework
 */
class PairContestantTeamGroupTable extends PluginPairContestantTeamGroupTable
{
    /**
     * Returns an instance of this class.
     *
     * @return object PairContestantTeamGroupTable
     */
    ...
    //
	public static function processNew ( $_tournamentID, $_sportGameID, $_sportGameTokenID, $_sportGameFullName, $_groupTypeID, $_groupTypeName, $_contestantTeamMode, $_genderCategory, $_groupStatus, $_groupCode, $_description )
	{
			$_sportGameGroup = self::processSave ( $_tournamentID, $_sportGameID, $_sportGameTokenID, $_sportGameFullName, $_groupTypeID, $_groupTypeName, $_contestantTeamMode, $_genderCategory, $_groupStatus, $_groupCode, $_description);
	...
	public static function processSave ( $_tournamentID, $_sportGameID, $_sportGameTokenID, $_sportGameFullName, $_groupTypeID, $_groupTypeName, $_contestantTeamMode, $_genderCategory, $_groupStatus, $_groupCode, $_description )
	{
		//try {
			...
			$_nw = new PairContestantTeamGroup (); 
  ...
  // process list selection function 
   public static function processSelection ( $_orgID=null, $_orgTokenID=null, $_categoryID=null, $_gameTypeID=null, $_keyword=null, $_offset=0, $_limit=10 ) 
   {
		$_qry = Doctrine_Query::create()
				...
				->from("PairContestantTeamGroup trnmtMtch") 
