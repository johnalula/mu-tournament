...
abstract class BaseTournamentMatchFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'match_number'           => new sfWidgetFormFilterInput(),
      'match_season'           => new sfWidgetFormFilterInput(),
      'participant_team_mode'  => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'match_number'           => new sfValidatorPass(array('required' => false)),
      'match_season'           => new sfValidatorPass(array('required' => false)),
      'participant_team_mode'  => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
