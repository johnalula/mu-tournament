...
abstract class BaseTournamentMatchFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'tournament_match_result_mode'     => new sfWidgetFormFilterInput(),
      'round_type_mode'                  => new sfWidgetFormFilterInput(),
      'contestant_team_mode'             => new sfWidgetFormFilterInput(),
      'competition_mode'                 => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'tournament_match_result_mode'     => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      ...
      'competition_mode'                 => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
  ...
  public function getFields()
  {
    return array(
      ...
      'tournament_match_result_mode'     => 'Number',
