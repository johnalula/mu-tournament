...
abstract class BaseSportGameFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'team_contestants_per_game_mode'         => new sfWidgetFormFilterInput(),
      ...
      'enable_fixed_contestant_per_track_flag' => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
      'enable_player_mode_flag'                => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
    ...
    $this->setValidators(array(
      ...
      'team_contestants_per_game_mode'         => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      ...
      'enable_fixed_contestant_per_track_flag' => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
      'enable_player_mode_flag'                => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
  ...
  public function getFields()
  {
    return array(
      ...
      'team_contestants_per_game_mode'         => 'Number',
      ...
      'enable_fixed_contestant_per_track_flag' => 'Boolean',
      'enable_player_mode_flag'                => 'Boolean',
