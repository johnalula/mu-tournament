...
abstract class BaseTournamentMatchTeamMemberParticipantFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'group_participant_team_member_token_id'     => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'group_participant_team_member_id'           => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('TournamentGroupParticipantTeamMember'), 'column' => 'id')),
      'group_participant_team_member_token_id'     => new sfValidatorPass(array('required' => false)),
  ...
  public function getFields()
  {
    return array(
      ...
      'group_participant_team_member_id'           => 'ForeignKey',
      'group_participant_team_member_token_id'     => 'Text',
      'effective_date'                             => 'Text',
