...
abstract class BaseTournamentMatchTeamMemberParticipantFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'team_group_member_participant_id'           => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'team_group_member_participant_id'           => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
  ...
  public function getFields()
  {
    return array(
      ...
      'team_group_member_participant_id'           => 'Number',
