...
/**
 * TeamGroup filter form base class.
 *
 * @package    mu-TMS
 * @subpackage filter
 ...
 */
abstract class BaseTeamGroupFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('team_group_filters[%s]');
