...
/**
 * TournamentMatchTeamMedalAwardParticipant filter form base class.
 *
 * @package    symfony
 * @subpackage filter
 ...
 */
abstract class BaseTournamentMatchTeamMedalAwardParticipantFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'tournament_match_team_medal_award_id'    => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('TournamentMatchTeamMedalAward'), 'column' => 'id')),
      'tournament_match_fixture_participant_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('TournamentMatchTeamMemberParticipant'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('tournament_match_team_medal_award_participant_filters[%s]');
  ...
  public function getFields()
  {
    return array(
      ...
      'tournament_match_team_medal_award_id'    => 'ForeignKey',
      'tournament_match_fixture_participant_id' => 'ForeignKey',
