...
abstract class BaseGameCategoryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'measurement_flag' => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
    ...
    $this->setValidators(array(
      ...
      'measurement_flag' => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
