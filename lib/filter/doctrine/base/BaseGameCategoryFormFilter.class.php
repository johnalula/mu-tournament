...
abstract class BaseGameCategoryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'contestant_name_mode' => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'contestant_name_mode' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
