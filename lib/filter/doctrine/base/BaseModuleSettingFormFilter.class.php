...
/**
 * ModuleSetting filter form base class.
 *
 * @package    symfony
 * @subpackage filter
 * @author     John Haftom
 ...
 */
abstract class BaseModuleSettingFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'module_type_id'               => new sfWidgetFormFilterInput(),
      'module_name'                  => new sfWidgetFormFilterInput(),
      'alias'                        => new sfWidgetFormFilterInput(),
      'default_access_level_type_id' => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'module_type_id'               => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'module_name'                  => new sfValidatorPass(array('required' => false)),
      'alias'                        => new sfValidatorPass(array('required' => false)),
      'default_access_level_type_id' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
    ...
    $this->widgetSchema->setNameFormat('module_setting_filters[%s]');
  ...
  public function getFields()
  {
    return array(
      ...
      'module_name'                  => 'Text',
      'alias'                        => 'Text',
      'default_access_level_type_id' => 'Number',
