...
abstract class BaseTournamentMatchFixtureGroupFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'group_participant_team_id'            => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'group_participant_team_id'            => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
  ...
  public function getFields()
  {
    return array(
      ...
      'group_participant_team_id'            => 'Number',
