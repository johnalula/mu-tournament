...
abstract class BaseTournamentMatchParticipantTeamFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'sport_game_team_group_id'       => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'sport_game_team_group_id'       => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
  ...
  public function getFields()
  {
    return array(
      ...
      'sport_game_team_group_id'       => 'Number',
