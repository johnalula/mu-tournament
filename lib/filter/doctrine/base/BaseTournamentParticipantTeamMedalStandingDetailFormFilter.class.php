...
abstract class BaseTournamentParticipantTeamMedalStandingDetailFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'medal_award_mode'                         => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'medal_award_mode'                         => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
