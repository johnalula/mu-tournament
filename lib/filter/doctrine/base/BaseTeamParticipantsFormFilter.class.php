...
/**
 * TeamParticipants filter form base class.
 *
 * @package    mu-TMS
 * @subpackage filter
 ...
 */
abstract class BaseTeamParticipantsFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'game_participation_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('TeamGameParticipation'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('team_participants_filters[%s]');
  ...
  public function getFields()
  {
    return array(
      'id'                    => 'Number',
      'token_id'              => 'Text',
      'game_participation_id' => 'ForeignKey',
      'team_id'               => 'ForeignKey',
