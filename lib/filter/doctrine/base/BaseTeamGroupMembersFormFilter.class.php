...
/**
 * TeamGroupMembers filter form base class.
 *
 * @package    mu-TMS
 * @subpackage filter
 ...
 */
abstract class BaseTeamGroupMembersFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'team_group_id'  => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('TeamGroup'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('team_group_members_filters[%s]');
