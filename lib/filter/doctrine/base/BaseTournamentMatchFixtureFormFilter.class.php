...
abstract class BaseTournamentMatchFixtureFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'number_of_teams_per_fixture'                   => new sfWidgetFormFilterInput(),
      'number_of_participants_per_fixture'            => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'number_of_teams_per_fixture'                   => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'number_of_participants_per_fixture'            => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
  ...
  public function getFields()
  {
    return array(
      ...
      'number_of_teams_per_fixture'                   => 'Number',
      'number_of_participants_per_fixture'            => 'Number',
