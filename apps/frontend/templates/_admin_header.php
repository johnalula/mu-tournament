			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li><a href="<?php echo url_for('home/index') ?>"><?php echo __('Game Category') ?></a></li>
						<li><a href="<?php echo url_for('home/index') ?>"><?php echo __('Games') ?></a></li>
						<li role="separator" class="divider"></li>
						<li class="dropdown-header"><?php echo __('Group Type') ?></li>
						<li><a href="<?php echo url_for('home/index') ?>"><?php echo __('Groups') ?></a></li>
						<li><a href="<?php echo url_for('home/index') ?>"><?php echo __('Group Members') ?></a></li>
					</ul>
				</li>
				<li class="dropdown">
