...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title><?php echo __('MU-eTMS Tournament Management System') ?></title> 
		<?php include_metas() ?>
		<?php include_title() ?>
	...
	<body >   
	 ...
	 <!-- Fixed navbar 0945525171-->
		...
		<?php if($sf_user->isAuthenticated()): ?> 
			<div class="container ui-background" id=""> 
				<div class="ui-container ui-top" id=""> 
