<div id="" class="navbar-collapse ui-toolbar">
	...
	<!-- ************ Account Chart Management ********************** -->
		<li class="">
			<button title="<?php echo __('Save Team Member Information') ?>" id="createTeamMemberRole" class="ui-disabled-toolbar-btn" disabled >
				<img class="navbar-nav-img" src="<?php echo image_path('icons/save') ?>">
				<?php echo __('Save') ?>
			</button>
		</li>	
		<li class="">
			<button title="<?php echo __('Cancel Team Member Information') ?>" id="cancelTeamMemberRole" class="ui-disabled-toolbar-btn" disabled>
