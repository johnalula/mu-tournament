	...
	<table class="ui-grid-table">
	  <thead>
		 <tr>
			...
			<th class="" style="text-align:center!important;"><?php echo __('F') ?></th>
			<th class="" style="text-align:center!important;"><?php echo __('M') ?></th>
			<th class="" style="text-align:center!important;"><?php echo __('Mixed') ?></th>
		 ...
		 <tr class="<?php echo fmod($_key, 2) ? 'ui-table-td-even' : 'ui-table-td-odd' ?>"> 
			...
			<td class="ui-td-center-text ui-td-xsmall-00">
				<span rel="<?php echo $_candidateSportGame->id ?>" class="ui-table-status-small-icon" id="<?php echo $_candidateSportGame->id ?>">
					&nbsp;<img title="<?php echo $_candidateSportGame->id ?> " src="<?php echo image_path($_candidateSportGame->id ? 'status/apply':'status/reject')  ?>">&nbsp;
				</span>
			</td>  
			<td class="ui-td-center-text ui-td-xsmall-00">
				<span rel="<?php echo $_candidateSportGame->id ?>" class="ui-table-status-small-icon" id="<?php echo $_candidateSportGame->id ?>">
			...
			<td class="ui-td-left-text ui-td-xsmall-1"> 
				<?php echo TournamentCore::processDistanceTypeValue($_candidateSportGame->sportGameDistanceTypeID).' '.($_candidateSportGame->sportGameTypeMode ? (TournamentCore::processAthleticsTypeValue($_candidateSportGame->sportGameTypeMode)):$_candidateSportGame->id)   ?>
			</td>  
