			...
			<div class="ui-panel-grid-form12" id=""> 
				<fieldset  class="ui-form-fieldset-frame">
					...
					<div class="form-group">
						...
						<div class="col-sm-40"> 
							<input type="text" class="form-control" id="team_name" name="team[team_name]" placeholder="<?php echo __('Name') ?>" value="<?php echo $_team->team_name ?>">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label class="col-sm-20 control-label" title="<?php echo __('Team City') ?>"><?php echo __('City') ?>:<span class="ui-red-text">&nbsp;</span></label>
						<div class="col-sm-40"> 
