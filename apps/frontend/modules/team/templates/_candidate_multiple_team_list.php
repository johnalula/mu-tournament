<div class="table-responsive" id="ui-modal-data-table-list-candidate-sport-game-participation"> 
	<table class="ui-grid-table">
	  <thead>
		 <tr>
			<th><input type="checkbox" id="allcategorycheck" name="all-category-check" value="" /></th>
	   ...
	   <?php foreach ( $_candidateTeams as $_key => $_candidateTeam ): ?>
		 <tr class="<?php echo fmod($_key, 2) ? 'ui-table-td-even' : 'ui-table-td-odd' ?>"> 
			<td class="ui-table-td-left-border ui-table-td-xfw">
				<input type="checkbox" id="category-check-<?php echo $_key;?>" name="category-check[<?php echo $_candidateTeam->id;?>]" class="checkcategory" value="<?php echo  $_candidateTeam->id.'$'.$_candidateTeam->token_id.'$'.$_candidateTeam->teamName.'$'.$_candidateTeam->teamAlias.'$'.$_candidateTeam->teamAlias ?>" />
			</td>
			...
			<td class="ui-td-center-text ui-td-xsmall-00">
				<?php echo $_candidateTeam->hasGameParticipation ? 'True':'False' ?>
			</td>  
			<td class="ui-td-center-text ui-td-xsmall-00">
...
<?php  
	...
	function selectAll (dateValue) {
		document.getElementById('school_calendar_date').value = dateValue; 
		document.getElementById('calander_from_date').value = dateValue; 
	} 
