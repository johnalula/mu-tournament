...
<form class="form-horizontal" role="form" action="<?php echo url_for('tournament_award/createTournamentMatchMedalAward') ?>" id="createTournamentMatchAwardForm" name="createTournamentMatchAwardForm" method="post"> 
...
<script>
	/*$('#createTournamentMatchMedalAward').click(function(){
		var url = '<?php echo url_for('tournament_award/createTournamentMatchMedalAward')?>'; 
		var formName = 'createTournamentMatchAwardForm';
		var data = $("form#createTournamentMatchAwardForm").serialize();
	...
	$("#candidateSportGameCategoryModal").submit(function(e) { 
		if($("input[name=selectCandidate]:checked", this).length == 0)
			...
			$("#createTournamentMatchMedalAward").removeAttr("disabled").removeClass("ui-disabled-toolbar-btn").addClass("ui-toolbar-btn");
			$("#createTournamentMatchMedalAward").removeAttr("disabled").removeClass("ui-disabled-toolbar-btn");
