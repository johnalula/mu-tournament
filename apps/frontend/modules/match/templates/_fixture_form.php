				...
				<div class="ui-fieldset-frame-container ui-col-sm-fieldset">
					<fieldset class="ui-form-fieldset-frame">
						...
						<div class="form-group">
							...
							<div class="col-sm-30"> 
								<input type="text" class="form-control ui-text-right-align" id="qualifying_row_numbers"	name="tournament_match_fixture[qualifying_row_numbers]"	placeholder="<?php echo __('Qualifying Rows') ?>" required  >
							</div><!-- /input-group --> 
							...
							<div class="col-sm-30"> 
								<div class="btn-toolbar" role="toolbar">
									<div class="btn-group">
										<input type="hidden" class="form-control" id="qualifing_row_numbers_flag" name="tournament_match_fixture[qualifing_row_numbers_flag]" value="0" >
										<button type="button" class="btn btn-default btn-xs btn-padding-sm-0 " id="enabledQualifyingRowsYesButton" value="1" title="<?php echo __('Enable Qualifying Rows') ?>"><?php echo __('Yes') ?>
										<button type="button" class="btn btn-default btn-sm btn-padding-sm-0 btn-danger active" id="enabledQualifyingRowsNoButton" value="0" title="<?php echo __('Disabled Number of Teams') ?>"><?php echo __('No') ?> 
									</div> 
								</div>
							</div><!-- /input-group --> 
						</div>  
						<div class="form-group">
							...
							<div class="col-sm-30"> 
								<input type="text" class="form-control ui-text-right-align" id="best_qualifying_row_numbers"	name="tournament_match_fixture[best_qualifying_row_numbers]"	placeholder="<?php echo __('Best Qualifying Rows') ?>" required  >
							</div><!-- /input-group --> 
							...
							<div class="col-sm-30"> 
								<div class="btn-toolbar" role="toolbar">
									<div class="btn-group">
										...
										<button type="button" class="btn btn-default btn-xs btn-padding-sm-0 " id="enabledBestQualifyingRowsYesButton" value="1" title="<?php echo __('Enable Best Qualifying Rows') ?>"><?php echo __('Yes') ?>
										<button type="button" class="btn btn-default btn-sm btn-padding-sm-0 btn-danger active" id="enabledBestQualifyingRowsNoButton" value="0" title="<?php echo __('Disabled Best Qualifying Rows') ?>"><?php echo __('No') ?> 
									</div> 
								</div>
							</div><!-- /input-group --> 
						</div>   
