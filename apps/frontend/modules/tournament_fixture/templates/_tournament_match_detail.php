<div class="ui-content-detail">
	<fieldset class="ui-content-detail-fieldset"> 
		<legend class="ui-content-detial-fieldset-legend">
				...
				<?php echo __('Team Group').' ( Sport Game: '.$_tournamentMatch->gameCategoryName.' - Group: '.TournamentCore::processGenderValue($_tournamentMatch->id).' - Code #:'.$_tournamentMatch->matchNumber.' )'  ?>
		</legend> 
