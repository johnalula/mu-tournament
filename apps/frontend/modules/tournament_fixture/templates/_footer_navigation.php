	...
	<?php if($sf_request->getParameter('module') == 'tournament_fixture'): ?>
		...
		<?php if(($sf_request->getParameter('match_fixture_id') == $_object->id) && $sf_request->getParameter('token_id') == $_object->token_id): ?>
			<?php if($sf_request->getParameter('action') == 'fixture'): ?>
				<li class="ui-nav-button">
					<a class="ui-nav-active-btn" href="<?php echo url_for(ModuleCore::makeModuleURLAction('match', 'match_fixture_id', 'edit', $_object)) ?>">
						<img class="navbar-nav-img" src="<?php echo image_path('pagination/previous_page') ?>">
						<?php echo __('Back') ?>
					</a>
				</li>	  
		...
		<?php if(($sf_request->getParameter('match_fixture_id') == $_object->id) && $sf_request->getParameter('token_id') == $_object->token_id): ?>
			<?php if($sf_request->getParameter('action') == 'participant_team'): ?>
				<li class="ui-nav-button">
					<a class="ui-nav-active-btn" href="<?php echo url_for(ModuleCore::makeModuleURLAction('match', 'match_fixture_id', 'fixture', $_object)) ?>">
						<img class="navbar-nav-img" src="<?php echo image_path('pagination/previous_page') ?>">
						<?php echo __('Back') ?>
					</a>
				</li>	   
		...
		<?php if(($sf_request->getParameter('match_fixture_id') == $_object->id) && $sf_request->getParameter('token_id') == $_object->token_id): ?>
			<?php if($sf_request->getParameter('action') == 'participant'): ?>
				<li class="ui-nav-button">
					<a class="ui-nav-active-btn" href="<?php echo url_for(ModuleCore::makeModuleURLAction('match', 'match_fixture_id', 'participant_team', $_object)) ?>">
						<img class="navbar-nav-img" src="<?php echo image_path('pagination/previous_page') ?>">
						<?php echo __('Back') ?>
					</a>
				</li>	   
		...
		<?php if(($sf_request->getParameter('match_fixture_id') == $_object->id) && $sf_request->getParameter('token_id') == $_object->token_id): ?>
			<?php if($sf_request->getParameter('action') == 'complete'): ?>
				<li class="ui-nav-button">
					<a class="ui-nav-active-btn" href="<?php echo url_for(ModuleCore::makeModuleURLAction('match', 'match_fixture_id', 'participant', $_object)) ?>">
						<img class="navbar-nav-img" src="<?php echo image_path('pagination/previous_page') ?>">
						<?php echo __('Back') ?>
					</a>
				</li>	   
	...
	<?php if($sf_request->getParameter('module') == 'tournament_fixture'): ?>
		...
		<?php if(($sf_request->getParameter('match_fixture_id') == $_object->id) && $sf_request->getParameter('token_id') == $_object->token_id): ?>
			<?php if($sf_request->getParameter('action') == 'participant_team'): ?>
				<li class="ui-nav-button " style="margin-right:5px!important;">
					<a class="ui-nav-active-btn" href="<?php echo url_for(ModuleCore::makeModuleURLAction('match', 'match_fixture_id', 'complete', $_object)) ?>">
		...
		<?php if(($sf_request->getParameter('match_fixture_id') == $_object->id) && $sf_request->getParameter('token_id') == $_object->token_id): ?>
			<?php if($sf_request->getParameter('action') == 'result'): ?>
				<?php if($_object->id && $_object->id && $_object->id ): ?>
					<li class="ui-nav-button ">
						<button id="approveTournamentMatch"  class="ui-nav-active-btn"  title="<?php echo __('Complete Team Grouping').' ( Name: '.$_object->id.' - Code #: '.$_object->id.' )' ?>">
				...
				<?php if($_object->id && $_object->id && !$_object->id ): ?>
					<li class="ui-nav-button ">
						<button id="completeTournamentMatch"  class="ui-nav-active-btn"  title="<?php echo __('Complete Team Grouping').' ( Name: '.$_object->id.' - Code #: '.$_object->id.' )' ?>">
							<img class="navbar-nav-img" src="<?php echo image_path('status/approved') ?>">
