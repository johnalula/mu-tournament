<?php
	...
	//echo SystemCore::makeAlias ( 'hand ball' );
	//$_flag =  GameCategoryTable::processNew ( $_orgID, $_orgTokenID, 'Athletics', $_categoryAlias, 'adfa df asdfasdf', $_userID, $_userTokenID  );  
?>
...
<script>
	$('#createGameCategory').click(function(){
		var url = '<?php echo url_for('game_category/createGameCategory')?>'; 
	...
	$('#createGameCategoryFooter').click(function(){
		var url = '<?php echo url_for('team/createGameCategory')?>'; 
		var formName = 'createGameCategoryForm';
		var data = $("form#createGameCategoryForm").serialize();
		var datas = generateValidData (formName);
		processEntry(datas, url )
