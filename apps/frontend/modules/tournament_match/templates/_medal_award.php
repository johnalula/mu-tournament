				...
				<div class="ui-grid-box" id="" style=""> 
					...
					<div class="ui-panel-header-default">
						<h2 class="ui-theme-panel-header">
							<img src="<?php echo image_path('settings/product') ?>" title="<?php echo __('Tournament Match Medal Award Standings Management') ?>">
							<?php echo __('Tournament Medal Award Standings') ?>
						</h2>
					...
					<!-- Begining of toolbar -->
						...
						<!--    End of toolbar      -->
						<div class="ui-panel-grid-list" id="medal_award"> 
							<?php include_partial('medal_award_list', array( '_participantTeams' => $_participantTeams )) ?> 
