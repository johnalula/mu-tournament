<div id="" class="navbar-collapse ui-toolbar">
	...
	<!-- ************ Tournament Match Fixtures ********************** -->
		 ...
		 <?php if($sf_request->getParameter('module') == 'match' ): ?>
				...
				<?php if($sf_request->getParameter('action') == 'member' ): ?>
				<li class="">
					<button title="<?php echo __('Add All Data Information') ?>" id="createBatchCandidateModalData" class=""  >
						<img class="navbar-nav-img" src="<?php echo image_path('icons/upload_all') ?>">
						<?php echo __('Add All') ?>
					</button>
				</li>	
				...
				<li class="">
					<button title="<?php echo __('Add All Data Information') ?>" id="createBatchCandidateTournamentMatchParticipantsData" class=""  >
						<img class="navbar-nav-img" src="<?php echo image_path('icons/upload_all') ?>">
						<?php echo __('Add All') ?>
					</button>
				</li>	
	...
	<!-- ************ Tournament Match Fixtures ********************** -->
		 ...
		 <?php if($sf_request->getParameter('module') == 'tournament_award' ): ?>
				<li class="">
					<button title="<?php echo __('Save Tournament Medal Award Information') ?>" id="insertCandidateModalData" class="ui-toolbar-btn"  >
						<img class="navbar-nav-img" src="<?php echo image_path('icons/upload') ?>">
						<?php echo __('Insert') ?>
					</button>
				</li>	
