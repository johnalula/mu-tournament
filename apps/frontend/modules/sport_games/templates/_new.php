			...
			<div class="ui-panel-grid">
				<div class="ui-panel-header-default">
					<h2 class="ui-theme-panel-header">
						<img src="<?php echo image_path('settings/team_group') ?>" title="<?php echo __('Sport Game Management') ?>">
					...
					<div class="ui-panel-content-box">
						<div class="ui-panel-detail-form-container" style=""> 
							<div class="ui-panel-form-content"> 
								<?php include_partial('form', array('_gameCategorys' => $_gameCategorys) ) ?> 
							</div> <!-- ui-panel-content -->
						</div> <!-- ui-panel-content -->
						
						<div class="ui-panel-footer-default-box">
							<h2 class="ui-theme-panel-header-title">
								<img src="<?php echo image_path('settings/team_group') ?>" title="<?php echo __('Sport Games') ?>">
								<?php echo __('Sport Games') ?>
							</h2>
						...
						<div class="ui-panel-content-box ">
							<div class="ui-panel-grid-list"> 
								<?php include_partial('list', array('_sportGames' => $_sportGames)) ?> 
							</div>
						</div> 
