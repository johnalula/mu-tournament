			...
			<div class="ui-panel-grid-form12" id=""> 
				<fieldset  class="ui-form-fieldset-frame">
					<legend class="ui-form-legend">
						<img src="<?php echo image_path('icons/add_icon') ?>" title="<?php echo __('Sport Game Information') ?>">
						<?php echo __('Sport Game') ?>
					</legend>
					<div class="form-group">
						<label for="firstname" class="col-sm-102 control-label"><?php echo __('Name') ?>:</label>
						<div class="col-sm-6">
							<input type="text" class="form-control" id="team_name" name="sport_game[team_name]" placeholder="<?php echo __('Name') ?>">
						</div>
					</div>
					<div class="form-group" style="border:0px solid #f00;">
						<label for="lastname" class="col-sm-102 control-label"><?php echo __('Alias') ?>:</label>
						<div class="col-sm-6">
							<input type="text" class="form-control" id="team_alias"	name="sport_game[team_alias]"	placeholder="<?php echo __('Alias') ?>">
						</div>
					</div>
					<div class="form-group" style="border:0px solid #f00;">
						<label for="season" class="col-sm-102 control-label"><?php echo __('Country') ?>:</label>
						<div class="col-sm-201">
							 <select id="country" name="sport_game[country]" class="form-control" title="<?php echo __('Team Country') ?>">
						...
						<div class="col-sm-201">
							 <input type="text" class="form-control" id="team_city"	name="sport_game[team_city]"	placeholder="<?php echo __('Team City') ?>">
						</div>
					</div> 
					<div class="form-group">
						<label for="lastname" class="col-sm-102 control-label">Decription</label>
						<div class="col-sm-6">
							<textarea class="form-control" rows=3 id="description" name="sport_game[description]" placeholder="<?php echo __('Description') ?>" title="<?php echo __('Description') ?>" ></textarea>
						</div>
					</div> 
				</fieldset> 
			</div> 
