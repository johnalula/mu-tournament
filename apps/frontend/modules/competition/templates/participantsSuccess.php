		...
		<div class="row ui-row-container">	 
			<div class="col-sm-6">
				<div class="ui-content-detail-box">
					<h2><?php echo strtoupper("Sport Games") ?> </h2> 
		...
		<div class="row">
			<div class="col-sm-12">
				<ul class="nav nav-tabs" id="myTab" style="background-color: #325889;">
					<li class="active">
					  <a href="#day_one">
						 <span style="display:block"><?php echo __('FASU Sport Games') ?></span> 
					  </a>
				  </li> 
				</ul>
					...
					<div class="tab-pane active" id="day_one"> 
						...
						<div class="col-sm-12">
							<div class="panel-content">
								<?php include_partial('sport_games_list', array('_candidateSportGames' => $_candidateSportGames)) ?>
							</div><!-- /.col-sm -->
						</div><!-- /.col-sm --> 
