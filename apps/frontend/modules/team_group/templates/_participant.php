					...
					<div class="ui-panel-content-box">
						<div class="ui-panel-detail-form-container" style=""> 
							<div class="ui-panel-form-content"> 
								<?php include_partial('participant_form', array('_sportGameTeamGroup' => $_sportGameTeamGroup,'_candidateGroups' => $_candidateGroups,'_activeTournament' => $_activeTournament,'_candidateGameCategorys' => $_candidateGameCategorys) ) ?> 
							</div> <!-- ui-panel-content -->
						</div> <!-- ui-panel-content -->
						
						<div class="ui-panel-footer-default-box">
							<h2 class="ui-theme-panel-header-title">
								<img src="<?php echo image_path('settings/team_group') ?>" title="<?php echo __('Team Group Participants') ?>">
								<?php echo __('Sport Game Participants') ?>
							</h2>
						</div><!-- ui-panel-footer-default -->
						
						<div class="ui-panel-content-box ">
							<div class="ui-panel-grid-list"> 
								<?php include_partial('participant_list', array('_candidateTeamMemberParticipants' => $_candidateTeamMemberParticipants)) ?> 
							</div>
						</div> 
