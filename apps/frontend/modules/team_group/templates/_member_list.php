			...
			<td class="ui-table-action ui-table-list-action-box-1">
				<div class="ui-table-list-action " id="">
					<ul class="ui-table-action-menu">   
						<li>   
							<a href="#" class="ui-action-button" id="ui-delete-cash_request-<?php echo $_caniddateParticipantTeam->id ?>" onclick="Javascript:deleteProduct(<?php echo $_caniddateParticipantTeam->id ?>);" rel="<?php echo $_caniddateParticipantTeam->token_id ?>">	
							<img title="<?php echo __('Delete Category').' ( '.' Task '.' #:'.$_caniddateParticipantTeam->id ?> )" src="<?php echo image_path('icons/del')  ?>" > 
							</a>  
						</li> 
					</ul>
				</div>
