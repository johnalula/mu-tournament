	...
	<table class="ui-grid-table">
	  <thead>
		 <tr>
			...
			<th class="ui-th-left-text" style="text-align:center!important;" title="<?php echo __('Team Group') ?>"><?php echo  __('# of Teams') ?></th>    
	  ...
	  <?php $_rowNumber = 1; foreach ( $_candidateTeamGroupParticipants as $_key => $_candidateGroupParticipantTeam ): ?>
