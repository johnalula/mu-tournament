		 ...
		 <tr class="<?php echo fmod($_key, 2) ? 'ui-table-td-even' : 'ui-table-td-odd' ?>"> 
			...
			<td class="ui-td-center-text ui-td-xsmall-0">
				<span rel="<?php echo $_tournamentSportGameGroup->id ?>" class="ui-table-status-small-icon" id="<?php echo $_tournamentSportGameGroup->id ?>">
					<img title="<?php echo $_tournamentSportGameGroup->id ?>" src="<?php echo image_path($_tournamentSportGameGroup->id ? 'status/approved':'status/disabled')  ?>"> 
