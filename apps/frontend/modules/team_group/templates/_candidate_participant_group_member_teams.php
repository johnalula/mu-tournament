<div class="table-responsive" id="ui-modal-data-table-list-candidate-group-participant-teams"> 
	   ...
	   <?php foreach ( $_candidateMemberTeams as $_key => $_candidateTeam ): ?>
		 <tr class="<?php echo fmod($_key, 2) ? 'ui-table-td-even' : 'ui-table-td-odd' ?>"> 
			...
			<td class="ui-td-left-text ui-td-xlarg">
				<?php echo Wordlimit::Wordlimiter($_candidateTeam->description, 7) ?>
			</td> 
