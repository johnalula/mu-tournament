			...
			<div class="ui-panel-grid">
				<div class="ui-panel-header-default">
					<h2 class="ui-theme-panel-header">
						...
						<?php echo __('Team Group').' ( Sport Game: '.$_tournamentTeamGroup->gameCategoryName  ?>
					</h2>
					...
					<div class="ui-panel-content-box">
						<div class="ui-panel-detail-form-container" style=""> 
							<div class="ui-panel-form-content"> 
								<?php include_partial('category_form', array('_tournamentTeamGroup' => $_tournamentTeamGroup, '_candidateGroups' => $_candidateGroups,'_activeTournament' => $_activeTournament,'_candidateGameCategorys' => $_candidateGameCategorys) ) ?> 
						...
						<div class="ui-panel-content-box ">
							<div class="ui-panel-grid-list"> 
								<?php include_partial('list', array('_tournamentTeamGroups' => $_tournamentTeamGroups)) ?> 
							</div>
						</div> 
