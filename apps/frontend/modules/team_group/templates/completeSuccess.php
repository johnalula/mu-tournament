	...
	<div class="ui-main-content-box" >
		<div class="ui-detail-tab-list ui-grid-content-container-box" >
			<div id="ui-tab-three" class="ui-tab" style="">
				<?php include_partial('complete', array( '_tournamentTeamGroup' => $_tournamentTeamGroup, '_groupParticipantTeams' => $_groupParticipantTeams , '_countGroupParticipantTeams' => $_countGroupParticipantTeams )) ?>
