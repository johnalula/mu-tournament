	...
	<div class="ui-main-content-box" >
		<div class="ui-detail-tab-list ui-grid-content-container-box" >
			<div id="ui-tab-three" class="ui-tab" style="">
				<?php include_partial('participant', array( '_sportGameTeamGroup' => $_sportGameTeamGroup, '_groupMemberTeams' => $_groupMemberTeams, '_candidateGroups' => $_candidateGroups, '_candidateGameCategorys' => $_candidateGameCategorys )) ?> 
...
<script>
	...
	$('.selectCandidateGroupMemberTeam').click(function() {   
		var url = '<?php echo url_for('team_group/candidateTeamGroupMember')?>'; 
	...
	$('.selectCandidateGroupMemberTeamParticipant').click(function() {   
		...
		var navName = $(this).attr('rel'); 
		var idName = 'candidate-team-member-participation';   
		//var data = 'tam_group_id='+document.getElementById('gender_category_id').value;
	...
	$("#candidateGroupMemberTeamParticipantModal").submit(function(e) { 
		if($("input[name=selectSportGameModal]:checked", this).length == 0)
			...
			document.getElementById("member_participant_name").value = listArr[2]+' ('+listArr[3]+')';    
			$("#createTeamGroupMember").removeAttr("disabled").removeClass("ui-disabled-toolbar-btn").addClass("ui-toolbar-btn");
			$("#cancelTeamGroupMember").removeAttr("disabled").removeClass("ui-disabled-toolbar-btn");
			$('#candidateGroupMemberTeamModal').modal('hide');
		return e.preventDefault();
